...
class _LoanAddState extends State<LoanAdd> {
  ...
  _calculations(){
    setState(() {
      ...
      remain = double.parse(amountController.text)- paymentPerMonth;
    });
  }
  ...
  onsave() async{
    ...
    if (form.validate()) {
      print('saved');
      form.save();
      LoanModel loan = new LoanModel(null, lenderController.text, _serviceDate, double.parse(amountController.text), double.parse(principalController.text), double.parse(interestController.text), double.parse(interestPaidController.text), paymentPerMonth, remain);
      DatabaseHelper helper = DatabaseHelper();
      await helper.insertLoan(loan);
