...
void main() {
  runApp(new MaterialApp(
    home: new GenerateJsonFile(),
  ));
}

class GenerateJsonFile extends StatefulWidget {
  @override
  State createState() => new GenerateJsonFileState();
}

class GenerateJsonFileState extends State<GenerateJsonFile> {
  ...
  void createFile(Map<String, dynamic> content, Directory dir, String fileName) {
    ...
    print("the absolute pathe"+file.absolute.path);
    file.createSync();
  ...
  void writeToFile(String key, dynamic value) {
    ...
    if (fileExists) {
      ...
      print("Absolute file path"+jsonFile.absolute.path);
    } else {
