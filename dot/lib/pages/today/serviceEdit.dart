...
class EditService extends StatefulWidget {
  ...
  EditService(this._service);
  @override
  _EditServiceState createState() => _EditServiceState(this._service);
}

class _EditServiceState extends State<EditService> {
  ServiceModel myservice;
  _EditServiceState(this.myservice);
  ...
  initState(){
    ...
    laborCostControl.text = myservice.laborCost.toString();
    otherExpenseControl.text = myservice.otherExpense.toString();
    sellingPriceControl.text = myservice.sellingPrice.toString();
    _serviceDate = myservice.date;
    hoursWorkControl.text = myservice.hourWork.toString();
    _time = myservice.time;
    serviceName = myservice.serviceName;
    serviceSegment = myservice.segment;
  }
  _grossProfit(){
    setState(() {
  ...
  Widget build(BuildContext context) {
    debugPrint(myservice.toMap().toString());
  ...
  void _submit() {
    ...
    if (form.validate()) {
      setState(() {
        _isLoading = true;
        form.save();
        ServiceModel service = new ServiceModel(myservice.id, serviceName, serviceSegment, double.parse(laborCostControl.value.text), double.parse(otherExpenseControl.value.text), double.parse(sellingPriceControl.value.text), int.parse(hoursWorkControl.value.text), _serviceDate, _time, grossProfit);
