...
class EditProduct extends StatefulWidget {
  ...
  EditProduct(this.products);
  ProductsModel products;
  @override
  _EditProductState createState() => _EditProductState(this.products);
}
...
class _EditProductState extends State<EditProduct> {
  ...
  void initState() {
    ...
    itemNameController.text=product.itemName.toString();
    productCostController.text=product.productCost.toString();
    quantityController.text=product.quantity.toString();
    totalPrice=product.totalPrice;
    grossProfit=product.grossProfit;
    totalCost=product.productCost;
    _serviceDate=product.serviceDate;
    _time=product.time;
  ...
  void submit() {
    ...
    if (form.validate()) {
      setState(() {
        _isLoading = true;
        form.save();
        ProductsModel products = ProductsModel.withId(product.id, itemNameController.text.toString(), double.parse(quantityController.text), double.parse(productCostController.text.toString()), double.parse(sellingPriceController.text.toString()), _serviceDate, _time, totalPrice, totalCost, grossProfit);
        var db = new DatabaseHelper();
        db.updateProduct(products);
        _isLoading = false;

        Navigator.pop(context);
//        _showSnackBar(context, 'product updated Success!');
      });
    }
    else{
      _autoValidate = true;
