...
class ExpenseEdit extends StatefulWidget {
  ...
  ExpenseEdit(this.otherExpenseModel);
  @override
  _ExpenseEditState createState() => _ExpenseEditState(otherExpenseModel);
}

class _ExpenseEditState extends State<ExpenseEdit> {
  _ExpenseEditState(this.otherExpense);
  OtherExpenseModel otherExpense;
  ...
  initState(){
    super.initState();
    setState(() {
      _expenceName = otherExpense.expenseName.toString();
      purchaseControl.text = otherExpense.purchaseCost.toString();
      _time = otherExpense.time.toString();
      _purchaseDate = otherExpense.serviceDate.toString();
    });
  }
  onsave() async{
    ...
    if (form.validate()) {
      print('saved');
      form.save();
      OtherExpenseModel otherExpenses = new OtherExpenseModel.withId(otherExpense.id, _expenceName, double.parse(purchaseControl.text), _purchaseDate, _time);
      DatabaseHelper helper = DatabaseHelper();
      await helper.updateOtherExpense(otherExpenses);
